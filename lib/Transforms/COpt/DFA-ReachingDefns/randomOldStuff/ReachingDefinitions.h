...
class DataFlowAnalysis {
  ...
  private:
    ...
    // The initial state of the analysis
		 ...
		 */
		void getIncomingEdges(int index, std::vector<int> * IncomingEdges) {
		 ...
		 */
		void getOutgoingEdges(int index, std::vector<int> * OutgoingEdges) {
     ...
     *   std::vector<int> & IncomingEdges: the vector of the indices of the source instructions of the incoming edges.
     *   std::vector<int> & IncomingEdges: the vector of indices of the source instructions of the outgoing edges.
